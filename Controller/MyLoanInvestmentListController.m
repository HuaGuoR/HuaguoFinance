...
@interface MyLoanInvestmentListController ()<HttpDelegate,UITableViewDataSource,UITableViewDelegate>{
    UIButton *leftButton;
...
@implementation MyLoanInvestmentListController
...
- (void)viewDidLoad
{
    ...
    self.navigationItem.title = @"我发布的贷款";
...
-(void)loadNetData:(int)page{
	...
	[parmDict setObject:@"uc_borrowed" forKey:@"act"];
