...
#define innerRadius    22.5
#define outerRadius    28.5

@implementation KDGoalBarPercentLayer
@synthesize percent;
@synthesize myUIColor;
...
-(void)DrawRight:(CGContextRef)ctx {
    ...
    CGContextSetFillColorWithColor(ctx, myUIColor.CGColor);
...
-(void)DrawLeft:(CGContextRef)ctx {
    ...
    CGContextSetFillColorWithColor(ctx, [UIColor colorWithRed:220/255.0 green:220/255.0 blue:220/255.0 alpha:1.0].CGColor);
